        ...
        <div className="controls">
          ...
          >
            ...
            {flats.map(flat => {
              ...
              if (status.toLowerCase() === "yes" || status.toLowerCase() === "sold" || status.toLowerCase() === "available") {
                statusEmoji = "✅"; // Green check for sold/available
              } else if (status.toLowerCase() === "no" || status.toLowerCase() === "unsold" || status.toLowerCase() === "unavailable") {
